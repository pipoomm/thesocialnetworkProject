...
<div class="row">
  <div class="col-xs-4">
	<input type="text" class="form-control" name="userID1" id="userID1" value="<?=(isset($_SESSION['user_id']))?$_SESSION['user_id']:''?>" placeholder="UserID 1">
	<input type="text" class="form-control" name="userID2" id="userID2" value="<?=(isset($_SESSION['user_id2']))?$_SESSION['user_id2']:''?>" placeholder="UserID 2">    
  </div>
  <div class="col-xs-5">
